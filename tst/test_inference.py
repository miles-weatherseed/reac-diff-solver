class ConjugateGradientsTest(unittest.TestCase):
    ...
    def test_dim_mismatch_b(self):
        ...
        with self.assertRaises(TypeError) as arctx:
            conjugate_gradients(A, b, x0)
        self.assertEqual(str(arctx.exception),
                         "The dimensions of the right hand side do not match the dimensions of the matrix provided.")
    ...
    def test_dim_mismatch_x0(self):
        ...
        with self.assertRaises(TypeError) as arctx:
            conjugate_gradients(A, b, x0)
        self.assertEqual(str(arctx.exception),
                         "The dimensions of the starting point do not match the dimensions of the matrix provided.")
